...
app = Flask(__name__)
key_id, key_secret = "<KEY ID>", "<KEY SECRET>"     #Key-ID & Key-Secret generated from the Razorpay Dashboard
...
def order_id(): 
	...
	if request.method == 'POST':
	    DATA = {
	        'amount': amount*100,  ## this is done as the api considerd sub-units while making payment. Which means 49900 paise instead of 499rs
	        'currency': 'INR',
